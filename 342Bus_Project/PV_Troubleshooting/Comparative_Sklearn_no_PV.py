...
###ConfusionMatrixDisplay(cm, display_labels=confusion_mat_labels).plot(xticks_rotation = 35).ax_.set_title("Naive Bayes Confusion Matrix")
###plt.show()
##cm = confusion_matrix(y_test, pred_list, labels=confusion_mat_labels)#, labels=classes
...
##
###cm = confusion_matrix(y_test, pred_list, labels=confusion_mat_labels)#, labels=classes
###ConfusionMatrixDisplay(cm, display_labels=confusion_mat_labels).plot(xticks_rotation = 35).ax_.set_title("MLP Confusion Matrix")
###plt.show()
##cm = confusion_matrix(y_test, pred_list, labels=confusion_mat_labels)#, labels=classes
##cmp = ConfusionMatrixDisplay(cm, display_labels=confusion_mat_labels)#.plot(xticks_rotation = 35)#.ax_.set_title("kNN Confusion Matrix")
##fig, ax = plt.subplots(figsize=(12, 12)) 
