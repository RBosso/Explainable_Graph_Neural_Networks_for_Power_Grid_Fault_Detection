...
coord_path = os.getcwd()+'/123Bus/BusCoords.dat'
print(coord_path)
#coords = pd.read_csv(coord_path,header=0, names=['Bus','X','Y'],delimiter = '     ')#
coords = pd.read_csv(coord_path,header=None, names=['Bus','X','Y'],delimiter = '     ')#
print(coords)
